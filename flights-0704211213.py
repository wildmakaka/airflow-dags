...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="flights-0704211213",
...
notebook_op_7d726309_d7c7_47ff_9575_3e786fcfda60 = NotebookOp(
    name="clean_data",
    namespace="ml-workshop",
    task_id="clean_data",
    ...
    cos_bucket="airflow",
    cos_directory="flights-0704211213",
    cos_dependencies_archive="clean_data-7d726309-d7c7-47ff-9575-3e786fcfda60.tar.gz",
    pipeline_outputs=[],
    pipeline_inputs=["spark-info.txt"],
    image="quay.io/ml-on-k8s/elyra-spark:0.0.4",
    in_cluster=True,
...
notebook_op_7d726309_d7c7_47ff_9575_3e786fcfda60.image_pull_policy = "IfNotPresent"

(
    notebook_op_7d726309_d7c7_47ff_9575_3e786fcfda60
    << notebook_op_5ad53c7e_c1a5_4dab_b766_cd6e3642891a
)
